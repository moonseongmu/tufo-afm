...
void start_oscillations(sweep_settings_t *settings, dds_t *sin_dds, dds_t *cos_dds, uint32_t block_size, active_buffer_t *active_buffer, uint16_t *sin_buf_1, uint16_t *sin_buf_2, uint16_t *cos_buf_1, uint16_t *cos_buf_2);
